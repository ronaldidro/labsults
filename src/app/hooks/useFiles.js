...
import { deleteFile, downloadFile, listFiles, uploadFile } from '../services/files'

export const useFiles = () => {
  const queryClient = useQueryClient()
  const files = queryClient.getQueryData('files')

  const useList = () => useQuery('files', listFiles)
  ...
  return { useList, useRemove, useUpload, download }
}
